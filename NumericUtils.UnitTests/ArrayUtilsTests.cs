...
namespace NumericUtils.UnitTests
{
    ...
    class ArrayUtilsTests
    {
        ...
        [Test, TestCaseSource(typeof(ArrayUtilsTestsData), "SortJaggedDelegateTestCases")]
        public int[][] SortJagged_CorrectArrayPassed_SortsCorrectly(int[][] array, Func<int[], int[], int>[] comparers)
        {
            ArrayUtils.SortJagged(array, comparers[0]);
    ...
    class ArrayUtilsTestsData
    {
        ...
        public static IEnumerable SortJaggedDelegateTestCases
        {
            get
            {
                yield return new TestCaseData(
                    new int[][]
                    {
                        ...
                        new int[] { -6 },
                        new int[] { 0, 1 }
                    }, new Func<int[], int[], int>[] { (int[] lhs, int[] rhs) => lhs.Sum() < rhs.Sum() ? -1 : lhs.Sum() == rhs.Sum() ? 0 : 1 })
                    .Returns(
                    new int[][] {
                        new int[] { -6 },
                        new int[] { 0, 1 },
                ...
                yield return new TestCaseData(
                    new int[][]
                    {
                        ...
                        new int[] { -6, 14 },
                        new int[] { 0, 1, -4, 7 }
                    }, new Func<int[], int[], int>[] { (int[] lhs, int[] rhs) => lhs.Max() < rhs.Max() ? -1 : (lhs.Max() == rhs.Max()) ? 0 : 1 })
                    .Returns(
                    new int[][] {
                        new int[] { 0, 1, -4, 7 },
                        new int[] { 5, 9 },
                ...
                yield return new TestCaseData(
                    new int[][]
                    {
                        ...
                        new int[] { -6 },
                        new int[] { 0, 1 }
                    }, new Func<int[], int[], int>[] { (int[] lhs, int[] rhs) => lhs.Min() < rhs.Min() ? -1 : (lhs.Min() == rhs.Min()) ? 0 : 1 })
                    .Returns(
                    new int[][] {
                        new int[] { -6 },
                        new int[] { 5, -3, 9},
